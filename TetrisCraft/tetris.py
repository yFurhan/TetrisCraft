...
class Text:
    ...
    def draw(self):
        self.font.render_to(self.app.screen, (WIN_W * 0.595, WIN_H * 0.02),
                            ...
                            size=TILE_SIZE * 1.65,)
        self.font.render_to(self.app.screen, (WIN_W * 0.65, WIN_H * 0.13),
                            text='CRAFT', fgcolor=self.get_color(),
                            size=TILE_SIZE * 1.65, )
        self.font.render_to(self.app.screen, (WIN_W * 0.70, WIN_H * 0.25),
                            text='Next', fgcolor='orange',
                            size=TILE_SIZE * 1.4,)
        self.font.render_to(self.app.screen, (WIN_W * 0.65, WIN_H * 0.67),
                            text='Score', fgcolor='orange',
                            size=TILE_SIZE * 1.4,)
        self.font.render_to(self.app.screen, (WIN_W * 0.75, WIN_H * 0.8),
